...
class FriendFragment: Fragment() {
    ...
    private fun onImageSelected(uri: Uri) {
        ...
        val user = auth.currentUser
        val tempMessage = FriendlyMessage(null, getUserName(), getUserEmail(), getPhotoUrl(), LOADING_IMAGE_URL)
        chatRef
            .push()
            .setValue(
                tempMessage,
            ...
            .addOnSuccessListener(
                ...
                taskSnapshot.metadata!!.reference!!.downloadUrl
                    .addOnSuccessListener { uri ->
                        val friendlyMessage =
                            FriendlyMessage(null, getUserName(), getUserEmail(), getPhotoUrl(), uri.toString())
                        chatRef
                            .child(key!!)
